package com.ssafy.gumipresso_admin.adapter.layoutmanager
...
class LinearLayoutManagerWithScroller : LinearLayoutManager {
    ...
    private inner class TopSnappedSmoothScroller(context: Context?) :
        ...
        override fun computeScrollVectorForPosition(targetPosition: Int): PointF? {
            return this@LinearLayoutManagerWithScroller
